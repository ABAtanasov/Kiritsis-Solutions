...
% 	\]
	...
	\[
		\left(-2 \ell_s^2\right)^2 \left(\frac{1}{y_{12}^2 y_{34}^2} + \frac{1}{y_{13}^2 y_{24}^2} + \frac{1}{y_{14}^2 y_{23}^2} \right) \to 4 \left(\eta^{\alpha \beta} \eta^{\gamma \delta} + \frac{\eta^{\alpha \gamma} \eta^{\beta \delta}}{(1-y)^{2}} + \frac{\eta^{\alpha \delta} \eta^{\beta \gamma}}{y^{2}} \right)  % z^{-\ell_s^2 t/2} (1-z)^{-\ell_s^2 u/2}
	\]
