...
guess for the non-extremal version of this would be to keep the dilaton and NS field the same and modify the metric to be
	...
	The IIB NS5 brane has $(1,1)$ SUSY and contains a vector multiplet
	
	The IIA NS5 brane has $(2,0)$ SUSY and contains a \emph{tensor} multiplet with \emph{six} scalars. 
