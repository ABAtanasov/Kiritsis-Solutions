...
% 	We still have $\epsilon_R = -1$
	...
	\[
	\begin{aligned}
		& e^{-2 \Phi} (\star H) \wedge F - \dd(e^{-\Phi} M_{ij} \star F^j) = 0\\
		& -\dd(e^{\Phi} M_{ij} \star F^j) + H \wedge F  = 0
	\end{aligned}
	\]
	This is equivalent under $\Phi \to - \Phi, e^{-2\Phi} H = \star H'$.
	
	The EOMs for the $B_{\mu \nu}$ give respectively 
	\[
	\begin{aligned}
		& -\dd (e^{-2 \Phi} \star H) = 0, \qquad &\dd H - F \wedge F = 0\\
		& -\dd (e^{-2 \Phi} \star H) + F \wedge F = 0, \qquad &\dd H = 0
	\end{aligned}
	\]
